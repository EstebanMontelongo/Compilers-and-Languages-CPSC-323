...
class Syntax
{
    ...
    void printSymbolTable(ofstream &oFile);
    void printFile(string fileName);
    bool checkMismatch(string type, const vector<string> &tokens,const vector<string> &lexems, int currIndex);
    void convertVectToAssembly(ofstream & oFile);
    //========================= Assignment Functions End =========================//


    private:
    //========================= Assignment 3 New Class Members =========================//
    int lineNum;
    unordered_map< string, pair<int, string>> symbolTable;
    vector<string> assemblyVector_;
    string assemblyOut_;
    //========================= Assignment Members End =========================//
